...
<div class="info-box">
	...
	<hr>
	<?php echo Form::open(array('action'=>'/org/student/csvstady','method'=>'post','enctype'=>'multipart/form-data')) ; ?>
	<p><?php echo __('CSVファイルを指定して「登録する」ボタンをクリックしてください。'); ?></p>
	<p class="mt4">
		<a href="/org/sample/classstady.csv"><i class="fa fa-download"></i><?php echo __('サンプルファイルのダウンロード'); ?></a>
	</p>
	<p><input type="file" name="se_csv"<?php echo $errClass['se_csv']; ?>></p>
	<p class="mt4"><?php echo __('※:sizeMBまでのCSVファイルが指定できます。',array('size'=>CL_FILESIZE)); ?></p>
	<?php echo $errMsg['se_csv']; ?>
	<?php
	...
	<div class="info-box table-box record-table admin-table mt0">
		...
		<tbody>
			...
			<tr>
				...
				<td class="text-center">20</td>
				<td class="font-silver font-size-80 width-50 line-height-14"><?php echo __('登録済みの学生ログインIDを入力。'); ?></td>
			</tr>
			</tbody>
		</table>
	</div>
