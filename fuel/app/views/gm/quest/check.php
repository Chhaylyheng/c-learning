...
<form action="/g/quest/submit/<?php echo $aQuest['qbID'].Clfunc_Mobile::SesID(); ?>" method="POST">
<?php echo Clfunc_Mobile::SesID('post'); ?>
<br>
<?php if ($aQuest['qbOpen'] == 2): ?>
	<div style="background-color: #0000CC; color: #FFFFFF; padding: 2px 0;"><?php echo __('氏名'); ?></div>
	<p><span style="color: #00CC00;"><?php echo $aInput['g_name']; ?></span></p>
