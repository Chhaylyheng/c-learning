...
<form action="/g/quest/ans/<?php echo $aQuest['qbID'].Clfunc_Mobile::SesID(); ?>" method="POST">
<?php echo Clfunc_Mobile::SesID('post'); ?>

<?php if ($aQuest['qbOpen'] == 2): ?>
<div>
	<?php echo __('氏名を入力してください。（必須）'); ?>
	<?php if (isset($aMsg['g_name'])): ?>
	<div style="color: #CC0000;"><?php echo $aMsg['g_name']; ?></div>
	<?php endif; ?>
	<p><input name="g_name" class="" value="<?php echo $aInput['g_name']; ?>" maxlength="50"></p>
</div>
<?php endif; ?>
...
<?php if (!is_null($aMsg)): ?>
	<div style="color: #CC0000; margin-bottom: 5px;"><?php echo Clfunc_Mobile::emj('WARN'); ?><?php echo __('入力に誤りがあります。各設問をご確認ください。'); ?></div>
<?php endif; ?>
<div style="text-align: center;"><input type="submit" value="<?php echo __('提出確認'); ?>"></div>
</form>
