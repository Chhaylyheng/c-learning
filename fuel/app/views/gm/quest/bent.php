...
<div style="background-color: #0000CC; color: #FFFFFF;"><?php echo __('設問.:no',array('no'=>$qNO)); ?><?php echo ($aQ['qqStyle'] == 1)? ' ※'.__('複数回答'):''; ?></div>
...
<?php endif; ?>
<div style="background-color: #CC0000; color: #ffffff; margin-top: 5px;"><?php echo __('回答'); ?></div>
