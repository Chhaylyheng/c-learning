...
<form action="/g/quest/submit/<?php echo $aQuest['qbID']; ?>" method="POST">
...
<?php if ($aQuest['qbOpen'] == 2): ?>
	<h2 class="QAHeader mt16"><span><?php echo __('氏名'); ?></span></h2>
	<div class="font-size-120 mt8 font-green ml16"><?php echo $aInput['g_name']; ?></div>
	<hr>
<?php endif; ?>
<?php
