<?php echo \View::forge('email/html_header', array('title'=>'[CL]学生パスワードの再設定')); ?>
...
<div align="center" class="button-container center" style="Margin-right: 10px;Margin-left: 10px;">
  ...
  <a href="<?php echo CL_PROTOCOL; ?>://<?php echo CL_DOMAIN; ?>/s/password/reset/<?php echo $reset_hash; ?>" target="_blank" style="color: #ffffff; text-decoration: none;">
    <!--[if mso]>
      <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="<?php echo CL_PROTOCOL; ?>://<?php echo CL_DOMAIN; ?>/s/password/reset/<?php echo $reset_hash; ?>" style="height:50px; v-text-anchor:middle; width:314px;" arcsize="10%" strokecolor="#0E408A" fillcolor="#0E408A" >
  ...
  <a href="<?php echo CL_PROTOCOL; ?>://<?php echo CL_DOMAIN; ?>/s/password/reset/<?php echo $reset_hash; ?>" target="_blank"><?php echo CL_PROTOCOL; ?>://<?php echo CL_DOMAIN; ?>/s/password/reset/<?php echo $reset_hash; ?></a>
  </div>
