...
<div style="line-height:10px;font-size:1px">&nbsp;</div>  <a href="http://c-learning.jp/" target="_blank">
<?php $sLogo = (CL_CAREERTASU_MODE)? 'logo_its':'logo'; ?>
<?php $sPath = \Asset::get_file($sLogo.'.png','img'); ?>
<?php if (preg_match('/^\/{2}/', $sPath)) $sPath = 'http:'.$sPath; ?>
<?php if (preg_match('/^\/{1}/', $sPath)) $sPath = CL_URL.$sPath; ?>
<img class="center" align="center" border="0" src="<?php echo $sPath; ?>" alt="<?php echo CL_SITENAME; ?>" title="<?php echo CL_SITENAME; ?>" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;width: 100%;max-width: 160px" width="160">
  </a>
