<?php echo \View::forge('email/html_header', array('title'=>'[CL]先生登録認証メール')); ?>
...
<!--[if mso]></td></tr></table><![endif]-->
                    ...
                    <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;"><![endif]-->
<div style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">
	<div style="font-size:12px;line-height:14px;color:#555555;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center">このメールアドレスはすでに<?php echo CL_SITENAME; ?>の先生として登録されています。<br>ログインして<?php echo CL_SITENAME; ?>の素晴らしい機能を体験しましょう。</p></div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<div align="center" class="button-container center" style="Margin-right: 10px;Margin-left: 10px;">
  ...
  <a href="<?php echo CL_PROTOCOL; ?>://<?php echo CL_DOMAIN; ?>/t" target="_blank" style="color: #ffffff; text-decoration: none;">
    <!--[if mso]>
      <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="<?php echo CL_PROTOCOL; ?>://<?php echo CL_DOMAIN; ?>/t" style="height:50px; v-text-anchor:middle; width:159px;" arcsize="10%" strokecolor="#0E408A" fillcolor="#0E408A" >
      <w:anchorlock/><center style="color:#ffffff; font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size:20px;">
    <![endif]-->
    <!--[if !mso]><!-->
    <div style="color: #ffffff; background-color: #0E408A; border-radius: 5px; -webkit-border-radius: 5px; -moz-border-radius: 5px; max-width: 139px; width: auto; border-top: 0px solid transparent; border-right: 0px solid transparent; border-bottom: 0px solid transparent; border-left: 0px solid transparent; padding-top: 5px; padding-right: 30px; padding-bottom: 5px; padding-left: 30px; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; text-align: center;">
    <!--<![endif]-->
  ...
  <a href="<?php echo CL_PROTOCOL; ?>://<?php echo CL_DOMAIN; ?>/t" target="_blank"><?php echo CL_PROTOCOL; ?>://<?php echo CL_DOMAIN; ?>/t</a>
    ...
    <div style="line-height:10px;font-size:1px">&nbsp;</div>
                    ...
                    <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;"><![endif]-->
<div style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">
	<div style="font-size:12px;line-height:14px;color:#555555;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center">もしかして、パスワードをお忘れですか？</p><p style="margin: 0;font-size: 14px;line-height: 16px;text-align: center"><a style="color:#0068A5;text-decoration: underline;" href="<?php echo CL_PROTOCOL; ?>://<?php echo CL_DOMAIN; ?>/t/password" target="_blank" rel="noopener noreferrer">パスワード再設定</a>より、新しいパスワードを設定できます。</p></div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
