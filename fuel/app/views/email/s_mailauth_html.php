<?php echo \View::forge('email/html_header', array('title'=>'[CL]メールアドレス認証メール')); ?>
...
<div style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">
	<div style="font-size:12px;line-height:14px;color:#555555;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center"><?php echo $aStudent['stName']?>様</p></div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
                    ...
                    <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;"><![endif]-->
<div style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">
	<div style="font-size:12px;line-height:14px;color:#555555;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center">以下のボタンを押して、メールアドレスを認証してください。</p></div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<div align="center" class="button-container center" style="Margin-right: 10px;Margin-left: 10px;">
  ...
  <a href="<?php echo CL_PROTOCOL; ?>://<?php echo CL_DOMAIN; ?>/s/entry/mailauth/<?php echo $sHash; ?>" target="_blank" style="color: #ffffff; text-decoration: none;">
    <!--[if mso]>
      <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="<?php echo CL_PROTOCOL; ?>://<?php echo CL_DOMAIN; ?>/s/entry/mailauth/<?php echo $sHash; ?>" style="height:50px; v-text-anchor:middle; width:314px;" arcsize="10%" strokecolor="#0E408A" fillcolor="#0E408A" >
    ...
    <!--<![endif]-->
      <span style="font-size:16px;line-height:32px;"><strong><span style="font-size: 20px; line-height: 40px;" data-mce-style="font-size: 20px; line-height: 40px;">メールアドレス認証</span></strong></span>
    <!--[if !mso]><!-->
    </div>
    <!--<![endif]-->
    <!--[if mso]>
  ...
  <a href="<?php echo CL_PROTOCOL; ?>://<?php echo CL_DOMAIN; ?>/s/entry/mailauth/<?php echo $sHash; ?>" target="_blank"><?php echo CL_PROTOCOL; ?>://<?php echo CL_DOMAIN; ?>/s/entry/mailauth/<?php echo $sHash; ?></a>
  </div>
...
<?php echo \View::forge('email/html_footer', array('mode'=>'s')); ?>
