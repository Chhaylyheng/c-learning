...
<div class="our-class">
	...
	<tr>
		...
		<td style="text-align: left;border: 1px solid #555;"><?php echo $aClass['ctCode']; ?></td>
                    ...
                    <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;"><![endif]-->
<div style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">
	<div style="font-size:12px;line-height:14px;color:#555555;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;"><span style="line-height: 16px; font-size: 14px;">メールアドレスとご登録いただきましたパスワードを<br>入力することで<?php echo CL_SITENAME; ?>をご利用いただけます。</span></div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
