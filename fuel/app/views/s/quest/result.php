...
<?php if (($aQuest['qbComPublic'] == 2 || ($aQuest['qbComPublic'] == 1 && !$bOther)) && $aPut['qpComment']): ?>
	<h2 class="QAHeader"><span><?php echo __('先生から個人宛てのコメント'); ?></span></h2>
	<p class="ml16 font-size-120 line-height-14"><?php echo nl2br($aPut['qpComment']); ?></p>
	<hr>
<?php endif; ?>
<?php
...
?>
	...
	?>
	<div>
		<p class="font-size-120 font-green mt8 ml16 pl20 <?php echo $sIcon; ?>">
			<?php echo $sText; ?>
		</p>
	</div>
	<?php endif; ?>
...
<?php if ($aQuest['qbReAnswer'] && $aQuest['qbPublic'] == 1 && !$bOther): ?>
	<div class="button-box mt32">
		<form action="/s/quest/ans/<?php echo $aQuest['qbID']; ?>" method="GET">
