...
<div class="info-box">
<form action="/t/quest/edit/<?php echo $aQuest['qbID']; ?>" method="post">
...
?>
	...
	<div class="button-box mt32">
		...
		<?php if ($aQuest['qbPublic'] != 1 && (!CL_CAREERTASU_MODE || $aTeacher['ttCTPlan'] > 0)): ?>
		<button type="submit" class="button do" name="next" value="1"><?php echo __('更新して設問編集へ'); ?></button>
		<?php endif; ?>
	</div>
</form>
</div>
