...
<div class="info-box">
	...
	<hr>
	<form action="/t/quest/submit/<?php echo $aQuest['qbID']; ?>" method="POST">
<?php
...
?>
	...
	<?php
		if ($aQ['qqStyle'] == 1):
			$aSel = ($aInput[$aQ['qqNO']]['select'])? explode('|',$aInput[$aQ['qqNO']]['select']):null;
		else:
			$aSel = ($aInput[$aQ['qqNO']]['select'])? array($aInput[$aQ['qqNO']]['select']):null;
		endif;
		$aChoice = array();
