...
?>
	...
	<section class="pt0">
		...
		<form action="/t/test/copy/<?php echo $aTest['tbID'] ?>" method="post" id="ClassCheckForm">
...
<?php
			foreach ($aClasses[1] as $sCtID => $aC):
				$sColor = ($sCtID == $aClass['ctID'])? 'font-blue':'';
?>
<tr class="<?php echo $sColor; ?>">
<td class="">
<input type="checkbox" name="selclass[]" class="Chk" value="<?php echo $sCtID; ?>">
</td>
<td class="">
