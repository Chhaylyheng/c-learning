<?php
	...
	if (isset($aTest)) {
		$sAction = 'editchk/'.$aTest['tbID'];
		$sImgPath = DS.CL_UPDIR.DS.$aTest['tbID'].DS.'base_tmp'.DS;
		$sImgValuePrefix = $aTest['tbID'].'_';
	} else {
		$sAction = 'create/'.$fKey;
		$sImgPath = DS.CL_UPDIR.DS.'temp'.DS.'test'.DS.$fKey.DS;
		$sImgValuePrefix = $fKey.'_';
	}
...
<?php endif; ?>
<form action="/t/test/<?php echo $sAction; ?>" method="post" enctype="multipart/form-data">
...
<?php
	...
	if ($tbImage):
		...
		$aBaseImg['value'] = $sImgValuePrefix.$tbImage;
	endif;
?>
		<div class="formGroup">
