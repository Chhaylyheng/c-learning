...
<div class="info-box">
	...
	<hr>
	<?php echo Form::open(array('action'=>'/t/student/csv','method'=>'post','enctype'=>'multipart/form-data')) ; ?>
	<p><?php echo __('学生登録のCSVファイルを指定して「登録する」ボタンをクリックしてください。'); ?></p>
	<p class="mt4">
		<a href="/t/sample/studentadd.csv"><i class="fa fa-download"></i><?php echo __('サンプルファイルのダウンロード'); ?></a>
	</p>
	...
	<div class="info-box table-box record-table admin-table mt0">
		...
		<tbody>
			<tr>
				...
				<td class="font-silver font-size-80 width-50 line-height-14"><?php echo __('半角大小英数字と一部記号【.（ドット）_（アンダースコア）-（ハイフン）】が利用可能'); ?></td>
			</tr>
			<tr>
				...
				<?php if (!$aGroup['gtLDAP']): ?>
					<?php echo __('半角大小英数字と一部記号【.（ドット）_（アンダースコア）-（ハイフン）/（スラッシュ）】で、文字種別を2種類以上組み合わせて入力。省略すると自動生成します。'); ?>
				<?php else: ?>
			...
			<tr>
				...
				<td class="text-center">1</td>
				<td class="text-center">1</td>
				<td class="font-silver font-size-80 width-50 line-height-14"><?php echo __('数値で 0:指定なし、1:男性、2:女性 で指定'); ?></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="font-silver font-size-80 width-50 line-height-14"><?php echo __('数値で入力します。'); ?></td>
			</tr>
			<tr>
