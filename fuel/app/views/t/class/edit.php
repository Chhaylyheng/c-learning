...
?>
<div class="info-box">
	<form action="/t/class/<?php echo $sAction; ?>" method="post">
...
<div style="margin: auto;" class="formControl">
	...
	<div class="formGroup">
		...
		<div class="formContent inline-box">
			<?php echo Form::select('c_year',$c_year,$yearlist,array('class'=>'dropdown')); ?>
		</div>
	</div>
	<div class="formGroup">
		<div class="formLabel"><?php echo __('期').DS.__('曜日').DS.__('時限'); ?></div>
		<div class="formContent inline-box">
			<?php echo Form::select('c_period',$c_period,$periodlist,array('class'=>'dropdown')); ?>
			<?php echo Form::select('c_weekday',$c_weekday,$weekdaylist,array('class'=>'dropdown')); ?>
			<?php echo Form::select('c_hour',$c_hour,$hourlist,array('class'=>'dropdown')); ?>
		</div>
	</div>

	<div class="formGroup">
		<div class="formLabel"><?php echo __('利用機能'); ?></div>
		<div class="formContent inline-box">
...
<div class="button-box mt16"><button type="submit" class="button do na" name="sub_state" value="1"><?php echo $sSubmit; ?></button></div>
	</form>
</div>
