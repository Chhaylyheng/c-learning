...
return array(
	...
	*/
	...
	'file'				=> array(
		'cookie_name'		=> 'sfid',				// name of the session cookie for file based sessions
		'path'				=>	'C:/xampp/tmp',					// path where the session files should be stored
