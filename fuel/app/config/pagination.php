...
return array(
	...
	'default'                     => array(
		...
		'first-marker'            => "|&lt;",
		'first-link'              => "\t\t<a href=\"{uri}\" style=\"letter-spacing: -4px;\" class=\"font-silver\">{page}</a>\n",
		...
		'previous-marker'         => "&lt;",
		'previous-link'           => "\t\t<a href=\"{uri}\" rel=\"prev\" class=\"font-silver\">{page}</a>\n",

		'previous-inactive'       => "<span class=\"previous-inactive\">\n\t{link}\n</span>\n",
		'previous-inactive-link'  => "\t\t<a href=\"#\" rel=\"prev\" class=\"font-silver\">{page}</a>\n",

		'regular'                 => "<span>\n\t{link}\n</span>\n",
		'regular-link'            => "\t\t<a href=\"{uri}\" class=\"font-silver\">{page}</a>\n",

		'active'                  => "<span class=\"active\">\n\t{link}\n</span>\n",
		'active-link'             => "\t\t<span class=\"font-default font-bold\">{page}</span>\n",

		'next'                    => "<span class=\"next\">\n\t{link}\n</span>\n",
		'next-marker'            => "&gt;",
		'next-link'               => "\t\t<a href=\"{uri}\" rel=\"next\" class=\"font-silver\">{page}</a>\n",

		'next-inactive'           => "<span class=\"next-inactive\">\n\t{link}\n</span>\n",
		'next-inactive-link'      => "\t\t<a href=\"#\" rel=\"next\" class=\"font-silver\">{page}</a>\n",

		'last'                    => "<span class=\"last\">\n\t{link}\n</span>\n",
		'last-marker'             => "&gt;|",
		'last-link'               => "\t\t<a href=\"{uri}\" style=\"letter-spacing: -4px;\" class=\"font-silver\">{page}</a>\n",
